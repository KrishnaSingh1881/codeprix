...
import { loginParticipant } from '@/lib/auth';
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-8 sm:px-6 sm:py-10">
        <div className="w-full max-w-4xl">
          <div className="w-full rounded-[26px] border border-white/12 bg-black/75 px-6 py-9 text-center shadow-[0_28px_70px_rgba(0,0,0,0.5)] sm:px-12 sm:py-12">
            ...
            <p className="mt-4 text-sm sm:text-base text-white/70">Code. Debug. Race to Victory.</p>

            <p className="mt-6 text-base sm:text-xl text-white/80 px-2">
              Welcome, <span className="font-semibold text-white break-all">{teamName || 'Racer'}</span>. Enter your credentials to unlock the pit lane.
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-10 space-y-6">
              ...
              <button
                ...
                className="w-full rounded-[22px] border border-[#E10600]/45 bg-[#E10600] px-8 py-4 sm:py-5 font-racing text-base sm:text-lg uppercase tracking-[0.18em] transition-all duration-200 hover:bg-[#ff1a0e] hover:border-[#ff1a0e]/60 hover:shadow-[0_0_30px_rgba(225,6,0,0.5)] active:scale-[0.98] disabled:cursor-not-allowed disabled:border-white/20 disabled:bg-white/20 disabled:text-white/70 disabled:shadow-none"
              >
                {sequenceRunning ? 'Unlocking...' : 'UNLOCK PIT LANE'}
              </button>
            </form>
          </div>
        </div>
